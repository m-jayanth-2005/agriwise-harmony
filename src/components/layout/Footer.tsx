...
const Footer = () => {
  return (
    <footer className="bg-soil-darker text-white mt-10">
      <div className="ag-container py-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              <Leaf className="h-6 w-6 text-soil-light" />
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/soil-analysis" className="text-gray-300 hover:text-white">
                  Soil Health Analysis
                </Link>
              </li>
              <li>
                <Link to="/disease-detection" className="text-gray-300 hover:text-white">
          ...
          <div className="col-span-1">
            ...
            <form className="flex flex-col sm:flex-row gap-2">
              <input
                ...
                className="px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-soil-light text-gray-800 w-full"
              />
              <button
                type="submit"
                className="bg-soil-light hover:bg-soil text-soil-darker px-4 py-2 rounded-md font-medium"
              >
                Subscribe
              </button>
            </form>
